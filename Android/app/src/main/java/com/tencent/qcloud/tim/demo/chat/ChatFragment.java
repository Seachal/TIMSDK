...
public class ChatFragment extends BaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        s  =  bundle.getString(Constants.ChatFragment);
        if (mChatInfo == null) {
            return null;
        }
    ...
    private void initView() {
        ...
        ChatLayoutHelper.customizeChatLayout(

                getActivity(), mChatLayout);
        ...
        mChatLayout.getMessageLayout().

                setOnItemClickListener(new MessageLayout.OnItemClickListener() {
                    @Override
        ...
        mChatLayout.getMessageLayout().
                setOnCustomMessageDrawListener(new ChatLayoutHelper.CustomMessageDraw());
    ...
    private  void  sendMessage(){
        if (!TextUtils.isEmpty(s)){
            MessageInfo info = MessageInfoUtil.buildCustomMessage("{\"text\": \"sc欢迎加入即时通信 IM 大家庭！查看详情>>\",\"link\": \"https://cloud.tencent.com/product/im\"}");
